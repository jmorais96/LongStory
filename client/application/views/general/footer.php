...
<footer id="footer">
	...
	<div class="footer-bottom">
		<p>Web Services Project <a rel="nofollow" href="#">Carina Gomes | José Morais</a></p>
	</div>
</footer>
<!-- End Footer -->
...
<!-- Bootstrap -->
<script src="<?php echo base_url('assets/css/preloader.css');?>../../assets/js/bootstrap.js"></script>
<!-- Slick Slider -->
