...
class Book_model extends CI_Model
{
    ...
    function getBookInfo($id)
    {
        ...
        $this->db->select("b.idBook, b.name, b.name, a.author, b.description, b.ISBN, b.image, group_concat(distinct g.gender) as gender, ifnull(round(avg(r.rating),1),'') as rating, b.idStatusBook, b.idAproved");
        $this->db->from("book as b");
        $this->db->join("author as a", "b.idAuthor = a.idAuthor");
